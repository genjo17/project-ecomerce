<section>
    <header>
        ...
        <p class="mt-1 text-sm text-slate-500">
            Nomor HP akan dipakai untuk kontak pengiriman dan prefill alamat.
        </p>
    </header>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-verification" class="text-sm font-semibold text-blue-950 underline decoration-blue-200 underline-offset-4 rounded-md transition hover:text-blue-900 focus:outline-none focus:ring-4 focus:ring-blue-100">
